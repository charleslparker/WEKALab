...
TechnicalInformationHandler {
    ...
    throws Exception {
        ...
        F1ModelSelection modSelection;     

        modSelection = new F1ModelSelection(m_minNumObj, instances);
        if (!m_reducedErrorPruning)
   ...
   <!-- options-end -->
    ...
    public static void main(String [] argv){
        Instances data = WekaInterface.readArffFile("timetest.arff");
        data.setClassIndex(data.numAttributes() - 1);
        Classifier c = new J48F1();
        try {
